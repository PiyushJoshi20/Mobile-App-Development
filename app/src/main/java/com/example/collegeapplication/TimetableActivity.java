...
//        ImageView icon6 = findViewById(R.id.icon6);
        ...
        icon1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Handle icon 1 click
                Toast.makeText(TimetableActivity.this, "Icon 1 clicked", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        icon2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Handle icon 2 click
                Toast.makeText(TimetableActivity.this, "Icon 2 clicked", Toast.LENGTH_SHORT).show();
            }
        });
